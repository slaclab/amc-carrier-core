...
class Adc32Rf45(pr.Device):
    def __init__(   self,       
        ...
        #######################        
        self.add(Adc32Rf45Channel(name='CHA',offset=(0x0 << 14),expand=False))
        self.add(Adc32Rf45Channel(name='CHB',offset=(0x8 << 14),expand=False))
        
        #######################
        # General Register Page 
        #######################
        self.addVariables(  name         = "RESET",
        ...
        self.addVariables(  name         = "3_OR_4_WIRE",
        ...
        self.addVariables(  name         = "PDN_CHB",
        ...
        self.addVariables(  name         = "GLOBAL_PDN",
        ...
        self.addVariables(  name         = "INCR_CM_IMPEDANCE",
        ...
        self.addVariables(  name         = "PDN_CHB_EN",
        ...
        self.addVariables(  name         = "SYNC_TERM_DIS",
        ...
        self.addVariables(  name         = "SYSREF_DEL_HI",
        ...
        self.addVariables(  name         = "SYSREF_DEL_LO",
                            description  = "When the SYSREF delay feature is enabled (3Ch, bit 6) the delay can be adjusted in 25-ps steps; the first step is 175 ps. The PVT variation of each 25-ps step is +/-10 ps. The 175-ps step is +/-50 ps",
                            offset       =  (generalAddr + (4*0x05A)),
                            bitSize      =  3,
                            bitOffset    =  5,
                            base         = "hex",
                            mode         = "RW",
        ...
        self.addVariables(  name         = "SEL_SYSREF_REG",
                            description  = "0 = SYSREF is logic low, 1 = SYSREF is logic high",
                            offset       =  (generalAddr + (4*0x057)),
                            bitSize      =  1,
                            bitOffset    =  4,
                            base         = "hex",
                            mode         = "RW",
        ...
        self.addVariables(  name         = "ASSERT_SYSREF_REG",
        ...
        self.addVariables(  name         = "SLOW_SP_EN2",
                            description  = "0 = ADC sampling rates are faster than 2.5 GSPS, 1 = ADC sampling rates are slower than 2.5 GSPS",
                            offset       =  (analogBank + (4*0x042)),
                            bitSize      =  1,
                            bitOffset    =  2,
                            base         = "hex",
                            mode         = "RW",
