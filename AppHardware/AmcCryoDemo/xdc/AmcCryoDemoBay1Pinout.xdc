...
set_property PACKAGE_PIN F6 [get_ports {jesdTxP[1][0]}] ; #P11 PIN47
set_property PACKAGE_PIN F5 [get_ports {jesdTxN[1][0]}] ; #P11 PIN48
set_property PACKAGE_PIN E4 [get_ports {jesdRxP[1][0]}] ; #P11 PIN44
set_property PACKAGE_PIN E3 [get_ports {jesdRxN[1][0]}] ; #P11 PIN45
set_property PACKAGE_PIN D6 [get_ports {jesdTxP[1][1]}] ; #P11 PIN53
set_property PACKAGE_PIN D5 [get_ports {jesdTxN[1][1]}] ; #P11 PIN54
set_property PACKAGE_PIN D2 [get_ports {jesdRxP[1][1]}] ; #P11 PIN50
set_property PACKAGE_PIN D1 [get_ports {jesdRxN[1][1]}] ; #P11 PIN51
...
set_property PACKAGE_PIN J4 [get_ports {jesdTxP[1][4]}] ; #P11 PIN32
set_property PACKAGE_PIN J3 [get_ports {jesdTxN[1][4]}] ; #P11 PIN33
set_property PACKAGE_PIN H2 [get_ports {jesdRxP[1][4]}] ; #P11 PIN29
set_property PACKAGE_PIN H1 [get_ports {jesdRxN[1][4]}] ; #P11 PIN30
set_property PACKAGE_PIN G4 [get_ports {jesdTxP[1][5]}] ; #P11 PIN38
set_property PACKAGE_PIN G3 [get_ports {jesdTxN[1][5]}] ; #P11 PIN39
set_property PACKAGE_PIN F2 [get_ports {jesdRxP[1][5]}] ; #P11 PIN35
set_property PACKAGE_PIN F1 [get_ports {jesdRxN[1][5]}] ; #P11 PIN36
