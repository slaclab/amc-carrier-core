...
set_property -dict { IOSTANDARD LVDS } [get_ports {syncInP[0][0]}]
set_property -dict { IOSTANDARD LVDS } [get_ports {syncInN[0][0]}]
set_property -dict { IOSTANDARD LVDS } [get_ports {syncInP[0][1]}]
set_property -dict { IOSTANDARD LVDS } [get_ports {syncInN[0][1]}]
set_property -dict { IOSTANDARD LVDS } [get_ports {syncInP[0][2]}]
set_property -dict { IOSTANDARD LVDS } [get_ports {syncInN[0][2]}]
set_property -dict { IOSTANDARD LVDS } [get_ports {syncInP[0][3]}]
set_property -dict { IOSTANDARD LVDS } [get_ports {syncInN[0][3]}]

set_property -dict { IOSTANDARD LVDS DIFF_TERM_ADV TERM_100 } [get_ports {syncOutP[0][0]}]
set_property -dict { IOSTANDARD LVDS DIFF_TERM_ADV TERM_100 } [get_ports {syncOutN[0][0]}]
set_property -dict { IOSTANDARD LVDS DIFF_TERM_ADV TERM_100 } [get_ports {syncOutP[0][1]}]
set_property -dict { IOSTANDARD LVDS DIFF_TERM_ADV TERM_100 } [get_ports {syncOutN[0][1]}]
set_property -dict { IOSTANDARD LVDS DIFF_TERM_ADV TERM_100 } [get_ports {syncOutP[0][2]}]
set_property -dict { IOSTANDARD LVDS DIFF_TERM_ADV TERM_100 } [get_ports {syncOutN[0][2]}]
set_property -dict { IOSTANDARD LVDS DIFF_TERM_ADV TERM_100 } [get_ports {syncOutP[0][3]}]
set_property -dict { IOSTANDARD LVDS DIFF_TERM_ADV TERM_100 } [get_ports {syncOutN[0][3]}]
