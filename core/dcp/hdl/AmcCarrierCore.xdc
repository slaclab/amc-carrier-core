...
# create_generated_clock -name axilClk      [get_pins -hier -filter {NAME =~ U_Pll/*/CLKOUT0}] 
# create_generated_clock -name xauiPhyClk   [get_pins -hier -filter {name =~ U_Eth/U_Xaui/XauiGthUltraScale_Inst/*/gthe3_channel_gen.gen_gthe3_channel_inst[0].GTHE3_CHANNEL_PRIM_INST/TXOUTCLK}]
