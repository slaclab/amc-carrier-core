...
set_property CLOCK_DEDICATED_ROUTE FALSE    [get_nets {U_Core/U_Core/U_DdrMem/refClock}]
set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets {U_Core/U_Core/U_DdrMem/refClkBufg}]

create_clock -name ddrClkIn   -period  5.000  [get_pins {U_Core/U_Core/U_DdrMem/BUFG_Inst/O}]
...
create_generated_clock -name axilClk      [get_pins -hier -filter {NAME =~ U_Core/U_Core/U_Pll/*/CLKOUT0}] 
create_generated_clock -name mpsClk625MHz [get_pins -hier -filter {NAME =~ U_Core/U_AppMps/U_Clk/U_ClkManagerMps/MmcmGen.U_Mmcm/CLKOUT0}] 
create_generated_clock -name mpsClk312MHz [get_pins -hier -filter {NAME =~ U_Core/U_AppMps/U_Clk/U_ClkManagerMps/MmcmGen.U_Mmcm/CLKOUT1}] 
create_generated_clock -name mpsClk125MHz [get_pins -hier -filter {NAME =~ U_Core/U_AppMps/U_Clk/U_ClkManagerMps/MmcmGen.U_Mmcm/CLKOUT2}] 
...
create_generated_clock -name xauiPhyClk   [get_pins -hier -filter {name =~ U_Core/U_Core/U_Eth/U_Xaui/XauiGthUltraScale_Inst/*/gthe3_channel_gen.gen_gthe3_channel_inst[0].GTHE3_CHANNEL_PRIM_INST/TXOUTCLK}]
create_generated_clock -name ddrIntClk0   [get_pins {U_Core/U_Core/U_DdrMem/MigCore_Inst/inst/u_ddr3_infrastructure/gen_mmcme3.u_mmcme_adv_inst/CLKOUT0}]
create_generated_clock -name ddrIntClk1   [get_pins {U_Core/U_Core/U_DdrMem/MigCore_Inst/inst/u_ddr3_infrastructure/gen_mmcme3.u_mmcme_adv_inst/CLKOUT6}]
create_generated_clock -name recTimingClk [get_pins -hier -filter {name =~ U_Core/U_Core/U_Timing/TimingGthCoreWrapper_1/LOCREF_G.U_TimingGthCore/*/RXOUTCLK}]  
