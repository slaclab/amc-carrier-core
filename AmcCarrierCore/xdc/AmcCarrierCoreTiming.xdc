...
set_clock_groups -asynchronous -group [get_clocks {axilClk}] -group [get_clocks -of_objects [get_pins {U_Core/U_SysReg/U_Iprog/GEN_ULTRA_SCALE.IprogUltraScale_Inst/BUFGCE_DIV_Inst/O}]]
set_clock_groups -asynchronous -group [get_clocks {axilClk}] -group [get_clocks -of_objects [get_pins {U_Core/U_SysReg/U_Version/GEN_DEVICE_DNA.DeviceDna_1/GEN_ULTRA_SCALE.DeviceDnaUltraScale_Inst/BUFGCE_DIV_Inst/O}]]
