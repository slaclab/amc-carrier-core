...
# LMK Ports
set_property -dict { PACKAGE_PIN V26  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkClkSel[0][0]}]
set_property -dict { PACKAGE_PIN V29  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkClkSel[0][1]}]
set_property -dict { PACKAGE_PIN W26  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkStatus[0][0]}]
set_property -dict { PACKAGE_PIN W29  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkStatus[0][1]}]
set_property -dict { PACKAGE_PIN T22  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkCsL[0]}]
set_property -dict { PACKAGE_PIN T23  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkSck[0]}]
set_property -dict { PACKAGE_PIN AP21 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkDio[0]}]
set_property -dict { PACKAGE_PIN AM24 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkSync[0]}]
set_property -dict { PACKAGE_PIN AP20 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {lmkRst[0]}]

# Fast ADC's SPI Ports
set_property -dict { PACKAGE_PIN AH16 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {adcCsL[0][0]}]
set_property -dict { PACKAGE_PIN AK17 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {adcCsL[0][1]}]
set_property -dict { PACKAGE_PIN AJ16 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {adcSck[0][0]}]
set_property -dict { PACKAGE_PIN AK16 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {adcSck[0][1]}]
set_property -dict { PACKAGE_PIN AH17 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {adcMiso[0][0]}]
set_property -dict { PACKAGE_PIN AK18 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {adcMiso[0][1]}]
set_property -dict { PACKAGE_PIN AH18 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {adcMosi[0][0]}]
set_property -dict { PACKAGE_PIN AJ18 IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {adcMosi[0][1]}]

# Fast DAC's SPI Ports
set_property -dict { PACKAGE_PIN U27  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {dacCsL[0]}]
set_property -dict { PACKAGE_PIN U26  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {dacSck[0]}]
set_property -dict { PACKAGE_PIN W28  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {dacMiso[0]}]
set_property -dict { PACKAGE_PIN Y28  IOSTANDARD LVCMOS18 SLEW FAST } [get_ports {dacMosi[0]}]
