...
# Backplane MPS Ports
set_property -dict { PACKAGE_PIN AD19 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[1]}]
set_property -dict { PACKAGE_PIN AD18 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[1]}]
set_property -dict { PACKAGE_PIN AG15 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[2]}]
set_property -dict { PACKAGE_PIN AG14 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[2]}]
set_property -dict { PACKAGE_PIN AG19 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[3]}]
set_property -dict { PACKAGE_PIN AH19 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[3]}]
set_property -dict { PACKAGE_PIN AJ15 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[4]}]
set_property -dict { PACKAGE_PIN AJ14 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[4]}]
set_property -dict { PACKAGE_PIN AG17 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[5]}]
set_property -dict { PACKAGE_PIN AG16 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[5]}]
set_property -dict { PACKAGE_PIN AL18 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[6]}]
set_property -dict { PACKAGE_PIN AL17 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[6]}]
set_property -dict { PACKAGE_PIN AK15 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[7]}]
set_property -dict { PACKAGE_PIN AL15 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[7]}]
set_property -dict { PACKAGE_PIN AL19 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[8]}]
set_property -dict { PACKAGE_PIN AM19 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[8]}]
set_property -dict { PACKAGE_PIN AL14 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[9]}]
set_property -dict { PACKAGE_PIN AM14 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[9]}]
set_property -dict { PACKAGE_PIN AP16 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[10]}]
set_property -dict { PACKAGE_PIN AP15 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[10]}]
set_property -dict { PACKAGE_PIN AM16 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[11]}]
set_property -dict { PACKAGE_PIN AM15 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[11]}]
set_property -dict { PACKAGE_PIN AN18 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[12]}]
set_property -dict { PACKAGE_PIN AN17 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[12]}]
set_property -dict { PACKAGE_PIN AM17 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[13]}]
set_property -dict { PACKAGE_PIN AN16 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[13]}]
set_property -dict { PACKAGE_PIN AN19 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxP[14]}]
set_property -dict { PACKAGE_PIN AP18 IOSTANDARD LVDS DIFF_TERM_ADV NONE } [get_ports {mpsBusRxN[14]}]
