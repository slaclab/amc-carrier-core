...
set_property -dict { PACKAGE_PIN Y28  IOSTANDARD LVCMOS18 } [get_ports {spareN[0][11]}]; #clSw[0][0] P12 PIN132
set_property -dict { PACKAGE_PIN W28  IOSTANDARD LVCMOS18 } [get_ports {spareP[0][11]}]; #clSw[0][1] P12 PIN133
set_property -dict { PACKAGE_PIN AE17 IOSTANDARD LVCMOS18 } [get_ports {fpgaClkP[0][1]}]; #clSw[0][2] P12 PIN74
set_property -dict { PACKAGE_PIN AF17 IOSTANDARD LVCMOS18 } [get_ports {fpgaClkN[0][1]}]; #clSw[0][3] P12 PIN75
set_property -dict { PACKAGE_PIN AE23 IOSTANDARD LVCMOS18 } [get_ports {syncOutN[0][7]}]; #clSw[0][4] P11 PIN138
set_property -dict { PACKAGE_PIN AE22 IOSTANDARD LVCMOS18 } [get_ports {syncOutP[0][7]}]; #clSw[0][5] P11 PIN139
set_property -dict { PACKAGE_PIN AK18 IOSTANDARD LVCMOS18 } [get_ports {spareN[0][9]}]; #clClkOe P12 PIN126
set_property -dict { PACKAGE_PIN AJ18 IOSTANDARD LVCMOS18 } [get_ports {spareP[0][9]}]; #rfAmpOn P12 PIN127
