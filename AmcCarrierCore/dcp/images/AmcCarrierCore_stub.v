...
module AmcCarrierCore(timingClk, timingRst, \timingBus[strobe] , 
  ...
  \timingPhy[control][pllReset] , timingPhyClk, timingPhyRst, diagnosticClk, diagnosticRst, 
  \diagnosticBus[strobe] , \diagnosticBus[data][31] , \diagnosticBus[data][30] , 
  \diagnosticBus[data][29] , \diagnosticBus[data][28] , \diagnosticBus[data][27] , 
  \diagnosticBus[data][26] , \diagnosticBus[data][25] , \diagnosticBus[data][24] , 
  \diagnosticBus[data][23] , \diagnosticBus[data][22] , \diagnosticBus[data][21] , 
  \diagnosticBus[data][20] , \diagnosticBus[data][19] , \diagnosticBus[data][18] , 
  \diagnosticBus[data][17] , \diagnosticBus[data][16] , \diagnosticBus[data][15] , 
  \diagnosticBus[data][14] , \diagnosticBus[data][13] , \diagnosticBus[data][12] , 
  \diagnosticBus[data][11] , \diagnosticBus[data][10] , \diagnosticBus[data][9] , 
  \diagnosticBus[data][8] , \diagnosticBus[data][7] , \diagnosticBus[data][6] , 
  \diagnosticBus[data][5] , \diagnosticBus[data][4] , \diagnosticBus[data][3] , 
  \diagnosticBus[data][2] , \diagnosticBus[data][1] , \diagnosticBus[data][0] , 
